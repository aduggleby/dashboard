...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  function initializeReorder() {
    ...
    grid.querySelectorAll("[data-move]").forEach((button) => {
      button.addEventListener("click", async (event) => {
        ...
        const card = current.closest("[data-card-id]");
  ...
  var LIGHT = "origami-light";
  var DARK = "origami-dark";
  var SUN_PATH = "M12 3a1 1 0 0 1 1 1v1a1 1 0 1 1-2 0V4a1 1 0 0 1 1-1Zm0 15a1 1 0 0 1 1 1v1a1 1 0 1 1-2 0v-1a1 1 0 0 1 1-1Zm9-7a1 1 0 1 1 0 2h-1a1 1 0 1 1 0-2h1ZM5 11a1 1 0 1 1 0 2H4a1 1 0 1 1 0-2h1Zm11.95-5.536a1 1 0 0 1 1.414 1.414l-.707.707a1 1 0 1 1-1.414-1.414l.707-.707Zm-9.9 9.9a1 1 0 0 1 1.414 1.414l-.707.707a1 1 0 1 1-1.414-1.414l.707-.707Zm11.314 2.121a1 1 0 0 1-1.414 0l-.707-.707a1 1 0 1 1 1.414-1.414l.707.707a1 1 0 0 1 0 1.414Zm-9.9-9.9a1 1 0 0 1-1.414 0l-.707-.707A1 1 0 1 1 7.757 5.46l.707.707a1 1 0 0 1 0 1.414ZM12 8a4 4 0 1 1 0 8 4 4 0 0 1 0-8Z";
  var MOON_PATH = "M21 12.79A9 9 0 1 1 11.21 3a1 1 0 0 1 1.03 1.35 7 7 0 0 0 7.41 9.41A1 1 0 0 1 21 12.79Z";
  function initializeTheme() {
    const root = document.documentElement;
    const toggle = document.getElementById("theme-toggle");
    const iconPath = document.querySelector("[data-theme-icon-path]");
  ...
  // scripts/ts/app.ts
  var TITLE_KEY = "dashboard-title";
  var DEFAULT_TITLE = "Homelab Dashboard";
  module_default.data("dashboardUi", () => ({
    addCardOpen: false,
    editCardOpen: false,
    settingsOpen: false,
    helpOpen: false,
    ...
    openEditCardFromElement(element) {
